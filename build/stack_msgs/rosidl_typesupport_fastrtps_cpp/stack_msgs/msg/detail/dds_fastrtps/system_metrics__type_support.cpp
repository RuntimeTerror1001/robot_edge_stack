...
#include "stack_msgs/msg/detail/system_metrics__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const stack_msgs::msg::SystemMetrics & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stack_msgs::msg::SystemMetrics & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_stack_msgs
max_serialized_size_SystemMetrics(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stack_msgs::msg::SystemMetrics;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stack_msgs::msg::SystemMetrics *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stack_msgs::msg::SystemMetrics *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SystemMetrics__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const stack_msgs::msg::SystemMetrics *>(
...
static size_t _SystemMetrics__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SystemMetrics(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SystemMetrics__callbacks = {
  "stack_msgs::msg",
  "SystemMetrics",
...
static rosidl_message_type_support_t _SystemMetrics__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SystemMetrics__callbacks,
...
{
  return &stack_msgs::msg::typesupport_fastrtps_cpp::_SystemMetrics__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stack_msgs, msg, SystemMetrics)() {
  return &stack_msgs::msg::typesupport_fastrtps_cpp::_SystemMetrics__handle;
}
