...
static const _SystemMetrics_type_support_symbol_names_t _SystemMetrics_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stack_msgs, msg, SystemMetrics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, stack_msgs, msg, SystemMetrics)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, stack_msgs, msg, SystemMetrics)() {
  return &::stack_msgs::msg::rosidl_typesupport_c::SystemMetrics_message_type_support_handle;
}
